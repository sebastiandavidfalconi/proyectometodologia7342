...
namespace CapaPresentacion
{
    public partial class frmTrabajador : Form
    {
        ...
        public frmTrabajador()
        {
            ...
            this.ttMensaje.SetToolTip(this.txtUsuario, "Ingrese el usuario para que el trabajador inicie sesión");
            this.ttMensaje.SetToolTip(this.txtPassword, "Ingrese la contraseña del trabajador");
